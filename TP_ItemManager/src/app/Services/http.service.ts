...
export class HttpService {
  ...
  FilterDevice(filter: any) {
    return this.http.post<any>(this.urlAPI + 'Devices', filter);
  }
  FilterStore(filter: any) {
    return this.http.post<any>(this.urlAPI + 'Stores', filter);
  }
  FilterMenu(filter: any) {
    return this.http.post<any>(this.urlAPI + 'Menus', filter);
  }
  ...
  GetMenu(id: string) {
    return this.http.get<Kiosk>(this.urlAPI + 'Menu', {
      params: new HttpParams().append('id', id),
    });
    //
  }
